...
console.log("two\nlines"); // 2 строки
console.log("onelongline"); // 1 строка
...
// 3.6 Symbol - нужен чтобы имена свойств были нестроковыми
...
p[strname] = 1;
p[symname] = 2;
console.log(p[strname] + p[symname]);
// Метод toString на Symbol превратит в строку и символ и значение его аргумента
let a = Symbol("sim_x");
console.log(a.toString()); // => Symbol(sym_x)
// symbol всегда возвращает уникальное значение, однако, чтобы вернуть ключ ассоцииорованный
// с данным аргументом используется Symbol.for() саму строку при этом можно извлесь с помощью keyFor :
